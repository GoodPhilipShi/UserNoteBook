...
date modified: 星期五, 二月 24日 2023, 10:09:31 上午
---
...
>开始配置
>~~~shell
>./configure --prefix=`pwd`/../Python-3.8.5-build
>~~~
>编译 && 安装
>~~~shell
...
```
./bin/python3 -m pip install readline
```
...
```shell
./bin/pip3 install opencv-python siot xlrd xlwt schedule PyAutoGUI pygame unihiker jedi baidu-aip pinpong
```
